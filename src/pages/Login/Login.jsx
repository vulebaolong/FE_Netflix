...
function Login() {
	...
	return (
		<section className="login">
			<div className="flex justify-center items-start relative overflow-hidden h-[1500px]">
				...
				<div className="p-16 bg-black/60 max-w-md w-full" style={{ marginTop: `calc(${HEIGHT_HEADER} + 50px)` }}>
					...
					<div className="">
						<div className="flex items-center py-4 space-x-1">
							...
							<p className="px-3 text-sm dark:text-gray-400">Đăng nhập bằng tài khoản xã hội</p>
							<div className="flex-1 h-px sm:w-16 dark:bg-gray-700"></div>
						</div>
